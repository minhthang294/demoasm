					...
					<div class="col s12">
						<div class="form-group">
							<form action="category.php" method="POST">
								<label for="usr" style="color: white; font-size: 20px;">Category Name</label>
						  		<input type="text" class="form-control" id="usr" name="catName" style="color: white;" placeholder="New name, only letters,space, slash" pattern="^[A-Za-z -]+$" required>
