				...
				<div class="category-item" style="text-align: left; color: white;">
					<div class="col s8">
						<div class="form-group">
							<form id="form1" action="product.php" method="POST">
								<label for="prid" style="color: white; font-size: 20px;">Product ID:</label>
						  		<input type="number" class="form-control" id="prid" name="proId" style="color: white;" required>
						  		<span id="confirmId" class="confirmId"></span>
						  		<label for="prname" style="color: white; font-size: 20px;">Product Name:</label>
						  		<input type="text" class="form-control" id="prname" name="proName" style="color: white;" pattern="^[A-Za-z -]+$" required>
						  		<label for="fileToUpload" style="color: white; font-size: 20px;">Product Image:</label>
						  		<input type="file" name="proImage" id="fileToUpload" class="form-control" required>
						  		<label for="prprice" style="color: white; font-size: 20px;">Product Price:</label>
						  		<input type="number" class="form-control" id="prprice" name="prPrice" style="color: white;" step=".01" required>
						  		<label for="prdes" style="color: white; font-size: 20px;">Product Description:</label>
						  		<textarea name="proDes" id="prdes" cols="30" rows="5" class="form-control" required></textarea>
